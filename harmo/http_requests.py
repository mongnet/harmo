    ...
    def send_request(self, method: str, url: str, payload=None, header: Optional[dict]=None, flush_header=False, files: Optional[dict]=None, params: Optional[dict]=None, cookies_kwargs: Optional[dict]=None, timeout=60, **kwargs):
        ...
        try:
            ...
            try:
                ...
                logging.info("请求数据: " + str(payload.decode('utf-8') if payload and isinstance(payload,(bytes, bytearray)) else payload))
                ...
                res["request_payload"] =  payload.decode('utf-8') if payload and isinstance(payload,(bytes, bytearray)) else payload
            ...
            logging.error("请求数据: " +  str(payload.decode('utf-8') if payload and isinstance(payload,(bytes, bytearray)) else payload))
